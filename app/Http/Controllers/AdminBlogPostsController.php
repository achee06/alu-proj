<?php namespace App\Http\Controllers;
	...
	class AdminBlogPostsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
	        ...
	        $this->col = [];
			$this->col[] = array("label"=>"Categories Id","name"=>"categories_id","join"=>"categories,name");
		$this->col[] = array("label"=>"Title","name"=>"title" );
		$this->col[] = array("label"=>"Slug","name"=>"slug" );
		$this->col[] = array("label"=>"Content","name"=>"content" );
		$this->col[] = array("label"=>"Tags","name"=>"tags" );
		$this->col[] = array("label"=>"User Id","name"=>"cms_user_id","join"=>"cms_user,id");
